...
{
    static id <MWTheme> sharedTheme = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        // Create and return the theme:
            sharedTheme = [[MWDefaultTheme alloc] init];
    });
...
{
    id <MWTheme> theme = [self sharedTheme];
...
{
    id <MWTheme> theme = [MWThemeManager sharedTheme];
    [button setBackgroundImage:[theme buttonImageForState:UIControlStateDisabled] forState:UIControlStateDisabled];
    [button setBackgroundImage:[theme buttonImageForState:UIControlStateNormal] forState:UIControlStateNormal];
    [button setBackgroundImage:[theme buttonImageForState:UIControlStateHighlighted] forState:UIControlStateHighlighted];
    [button setBackgroundImage:[theme buttonImageForState:UIControlStateSelected] forState:UIControlStateSelected];
    [button setBackgroundImage:[theme buttonImageForState:UIControlStateSelected | UIControlStateHighlighted] forState:UIControlStateSelected | UIControlStateHighlighted];
}
